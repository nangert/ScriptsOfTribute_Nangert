...
class ReplayBuffer:
    ...
    def get_all(self):
        ...
        obs_keys = ["current_player", "enemy_player", "patron_tensor", "tavern_available", "tavern_cards", "start_of_turn_effects", "upcoming_effects"]
        ...
        obs = {
            k: pad_sequence(obs_unpadded[k], batch_first=True)
            for k in obs_keys
        }
        ...
        return obs, actions, rewards, move_tensor, old_log_probs, value_estimates, lengths_tensor
