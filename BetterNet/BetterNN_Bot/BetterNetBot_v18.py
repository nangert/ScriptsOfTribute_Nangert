...
from BetterNet.utils.game_state_to_tensor.game_state_to_vector_v7 import game_state_to_tensor_dict_v7
...
class BetterNetBot_v18(BaseAI):
    ...
    def __init__(
        ...
        model = BetterNetV18(hidden_dim=256, num_moves=10, num_cards=125).to(self.device)
    ...
    def play(
        ...
        obs = game_state_to_tensor_dict_v7(game_state)
