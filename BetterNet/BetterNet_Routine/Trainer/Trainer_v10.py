...
from BetterNet.ReplayBuffer.ReplayBuffer_v10 import ReplayBuffer_v10

# Device configuration
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

MODEL_PREFIX = "better_net_v10_"
EXTENSION = ".pt"
...
class Trainer_v10:
    ...
    def __init__(
        ...
        # Initialize model
        self.model = BetterNetV10(hidden_dim=128, num_moves=10).to(device)
        ...
        # Replay buffer
        self.buffer = ReplayBuffer_v10(self.buffer_path)
