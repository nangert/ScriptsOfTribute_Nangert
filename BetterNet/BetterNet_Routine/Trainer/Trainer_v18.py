...
from BetterNet.BetterNN.BetterNet_v18 import BetterNetV18
from BetterNet.ReplayBuffer.ReplayBuffer_v18 import ReplayBuffer_v18
...
class Trainer_v18:
    ...
    def __init__(
        ...
        # Initialize model
        self.model = BetterNetV18(hidden_dim=256, num_moves=10, num_cards=125).to(device)
        ...
        # Replay buffer
        self.buffer = ReplayBuffer_v18(self.buffer_path)
