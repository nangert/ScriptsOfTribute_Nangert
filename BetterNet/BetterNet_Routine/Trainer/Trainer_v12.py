...
from BetterNet.ReplayBuffer.ReplayBuffer_v12 import ReplayBuffer_v12

# Device configuration
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

MODEL_PREFIX = "better_net_v12_"
EXTENSION = ".pt"
...
class Trainer_v12:
    ...
    def __init__(
        ...
        # Initialize model
        self.model = BetterNetV12(hidden_dim=128, num_moves=10).to(device)
        ...
        # Replay buffer
        self.buffer = ReplayBuffer_v12(self.buffer_path)
