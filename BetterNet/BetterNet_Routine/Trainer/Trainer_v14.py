...
from BetterNet.ReplayBuffer.ReplayBuffer_v14 import ReplayBuffer_v14
...
class Trainer_v14:
    ...
    def __init__(
        ...
        # Initialize model
        self.model = BetterNetV14(hidden_dim=128, num_moves=10).to(device)
        ...
        # Replay buffer
        self.buffer = ReplayBuffer_v14(self.buffer_path)
