...
from BetterNet.BetterNN.BetterNet_v17 import BetterNetV17
from BetterNet.ReplayBuffer.ReplayBuffer_v17 import ReplayBuffer_v17
...
class Trainer_v17:
    ...
    def __init__(
        ...
        # Initialize model
        self.model = BetterNetV17(hidden_dim=128, num_moves=10, num_cards=125).to(device)
        ...
        # Replay buffer
        self.buffer = ReplayBuffer_v17(self.buffer_path)
    ...
    def train(
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            for start in range(0, B, batch_size):
                ...
                move_tensor_batch = [move_tensor_all[i] for i in batch_inds.tolist()]  # list len B', each [T_i][N_i]{tensor}
                feat_nested = []
