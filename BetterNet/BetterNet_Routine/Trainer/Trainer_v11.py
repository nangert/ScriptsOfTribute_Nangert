...
from BetterNet.ReplayBuffer.ReplayBuffer_v11 import ReplayBuffer_v11

# Device configuration
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

MODEL_PREFIX = "better_net_v11_"
EXTENSION = ".pt"
...
class Trainer_v11:
    ...
    def __init__(
        ...
        # Initialize model
        self.model = BetterNetV11(hidden_dim=128, num_moves=10).to(device)
        ...
        # Replay buffer
        self.buffer = ReplayBuffer_v11(self.buffer_path)
    ...
    def train(
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            for start in range(0, B, batch_size):
                ...
                logits_all, values = self.model(obs_batch, moves_batch)
