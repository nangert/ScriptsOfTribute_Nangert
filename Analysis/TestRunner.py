...
def main():
    ...
    bot1_path = Path('./model/v17/tribute_net_v29.pt')
    ...
    bot17_path = Path('../data/saved_models/BetterNet_v17/better_net_v26.pt')
    ...
    bot1 = BetterNetBot_v17(model_path=bot17_path, bot_name='better_net_v17', evaluate=True, save_trajectory=False)
