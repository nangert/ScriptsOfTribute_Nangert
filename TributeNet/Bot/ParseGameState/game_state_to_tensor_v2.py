...
from TributeNet.Bot.ParseGameState.cards_to_tensor_v1 import cards_to_tensor_pair_v1
from TributeNet.Bot.ParseGameState.patrons_to_tensor_v2 import patrons_to_tokens_v2
from TributeNet.Bot.ParseGameState.player_to_tensor_v1 import player_to_tensor_v1, opponent_to_tensor_v1


def game_state_to_tensor_v2(game_state: GameState) -> dict[str, torch.Tensor]:
    ...
    patron_ids, patron_states_rel, patron_present = patrons_to_tokens_v2(
        game_state.patron_states, game_state.current_player.player_id
    )
    obs.update({
        "patron_ids": patron_ids,
        "patron_states": patron_states_rel,
