...
class ReplayBuffer_V3:
    def __init__(self, batch_data: []):
        self.batch_data = batch_data

    def get_all(self):
        obs_keys = [
            "player_tensor", "opponent_tensor",
            "patron_ids", "patron_states", "patron_present",
        ...
        move_tensors_unpadded: List[List[List[dict]]] = []
        ...
        for episode in self.batch_data:
            ...
            ep_move_metadata: List[List[dict]] = []
            ep_move_tensors: List[List[dict]] = []
            ep_actions: List[int] = []
            ...
            for step in episode:
                ...
                ep_move_metadata.append(step["move_metadata"])
                ep_move_tensors.append(step["move_tensor"])
            ...
            move_meta_unpadded.append(ep_move_metadata)
            move_tensors_unpadded.append(ep_move_tensors)
        ...
        return obs_padded, actions, rewards, move_meta_unpadded, move_tensors_unpadded, old_log_probs, value_estimates, lengths_tensor
