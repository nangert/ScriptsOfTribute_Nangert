...
from TributeNet.Training.Trainer.Trainer_v2 import Trainer_V2
from TributeNet.utils.file_locations import SUMMARY_DIR, MERGED_SUMMARY_DIR
...
def main():
    ...
    while True:
        ...
        trainer = Trainer_V2(raw_data=data, epochs=args.epochs, lr=args.lr)
        trainer.train()
