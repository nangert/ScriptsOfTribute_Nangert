...
class RolloutWorker_V3:
    ...
    def run(self) -> None:
        ...
        bot1 = TributeBotV3(bot_name='TributeBot_1', evaluate=False, use_latest_model=True)
        bot2 = TributeBotV3(bot_name='TributeBot_2', evaluate=False, use_latest_model=False)
