...
from nn.BetterNet_v6 import BetterNetV6
...
class CompetitionBotV2(BaseAI):
    def __init__(
        ...
        self.model_path = Path('model/v6/tribute_net_v34.pt')
        self.patron_choice = patron_choice
        self.instant_moves = instant_moves
        self.remove_end_turn = remove_end_turn

        model = BetterNetV6(hidden_dim=128, num_moves=10, num_cards=125)
